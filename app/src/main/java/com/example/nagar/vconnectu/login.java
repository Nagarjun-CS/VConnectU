...
public class login extends AppCompatActivity {
    ...
    {
        Intent io = new Intent(getApplicationContext(),Register.class);
        startActivity(io);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new_email= mEmail.getEditableText().toString();
        new_pwd= mPassword.getEditableText().toString();
    ...
    private void processResult(String command) {
        ...
        if(command.indexOf("login") != -1)
        {
            ...
            fAuth.signInWithEmailAndPassword(new_email,new_pwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                @Override
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful())
                    {
        ...
        if(command.indexOf("create new account") != -1)
        {
    ...
    private void initializeTextToSpeech() {
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int i) {
                ...
                {
                    Toast.makeText(login.this, "There is no TTS engine on your phone", Toast.LENGTH_SHORT).show();
                    finish();
                }
                /*if(count == 0)
                {
